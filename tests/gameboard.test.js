...
describe("verify fleet status", () => {
  beforeEach(() => {
    ...
    gameboard.placeShip("destroyer", [0, 4], false);
    gameboard.placeShip("submarine", [0, 6], false);
    gameboard.placeShip("patrolBoat", [0, 8], false);
  });
  ...
  test("sunk fleet", () => {
    ...
    for (let i = 0; i < 3; i++) {
      gameboard.receiveAttack(i, 6);
    }
    for (let i = 0; i < 2; i++) {
      gameboard.receiveAttack(i, 8);
    }
